    ...
    >
      ...
      <ul className="notice-list">
        <li>
          ...
          <span style={{ color: "red", fontWeight: "bold" }}>50회</span> 이상
          시도하면 화면에 나타나는 문자열을 입력하고 계속 사용
        </li>
        <li>
          문자열 입력시{" "}
      ...
      <ul className="notice-list">
        ...
        <li>
          팝업차단 해제 방법으로 브라우저에서 “도구/인터넷옵션/팝업차단설정/”
          현재 사이트의 팝업을 항상 “허용”
        </li>
      </ul>
      ...
      <ul className="notice-list">
        <li>
          수강신청시스템은 최소 해상도는 1440*900 이며 1920*1024 해상도에 최적화
          되어 있으며 그 이상의 해상도로 화면 설정
        </li>
      </ul>
