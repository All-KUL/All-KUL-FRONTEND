    ...
    return (
        <div>
            ...
            <div>
                ...
                />
                <button onClick={handleAddLecture} disabled={!webSocketClient.isConnected || !lectureId}>
                    Add Lecture
                </button>
                <button onClick={handleDeleteLecture} disabled={!webSocketClient.isConnected || !lectureId}>
                    Delete Lecture
                </button>
                <button onClick={handleEnroll} disabled={!webSocketClient.isConnected || !lectureId}>
                    Enroll
                </button>
                <input
                    type="text"
                ...
                />
                <button onClick={sendMessage} disabled={!webSocketClient.isConnected || !message.trim()}>
                    Send
                </button>
                <div>
